...
abstract final class AppColors {
  ...
  static const Color sidebarBackground = Color(0xFF160A3A);
  ...
  static const Color textOnSidebar = Color(0xFFFFFFFF);
  static const Color textOnSidebarUnselected = Color(0xFF9CA3AF);
